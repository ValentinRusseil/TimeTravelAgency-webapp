...
const destinations = [
  ...
  },
  {
    id: "ancient-rome",
    title: "Rome 44 BCE",
    subtitle: "Fall of the Republic",
    description: "Experience the final days of the Roman Republic. Witness Senate proceedings and the political intrigue that would reshape Western civilization forever.",
    era: "Ancient Era",
    duration: "3-10 Days",
    difficulty: "Advanced",
    price: "From $95,000",
    theme: "classical",
    gradient: "from-red-900/40 via-stone-800/30 to-amber-900/40",
    accentColor: "oklch(0.65 0.18 25)",
    icon: (
      <svg className="w-12 h-12" viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="1.5">
        <path d="M8 40V20L24 8L40 20V40" />
        <path d="M16 40V24H32V40" />
        <path d="M12 20H36M16 28H32" />
  ...
  {
    id: "egypt-2500bce",
    title: "Egypt 2500 BCE",
    subtitle: "Age of Pyramids",
    description: "Walk the construction sites of Giza as the Great Pyramid rises stone by stone. Witness ancient engineering marvels that still defy modern explanation.",
    era: "Ancient Era",
    duration: "5-14 Days",
    difficulty: "Intermediate",
    price: "From $88,000",
    theme: "egyptian",
    gradient: "from-yellow-800/40 via-amber-700/30 to-orange-900/40",
    accentColor: "oklch(0.75 0.15 85)",
    icon: (
      <svg className="w-12 h-12" viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="1.5">
        <path d="M24 6L40 42H8L24 6Z" />
        <path d="M24 18L30 36H18L24 18Z" />
      ...
      <div className="relative">
        ...
        >
          ...
          {destinations.map((destination, index) => (
            ...
            >
              <div className={`relative h-[520px] rounded-3xl overflow-hidden glass hover:border-cyan-glow/30 transition-all duration-500`}>
                {/* Gradient background */}
                <div className={`absolute inset-0 bg-gradient-to-br ${destination.gradient} opacity-60`} />
                
                {/* Pattern overlay based on theme */}
                <div className="absolute inset-0 opacity-10" style={{
                  backgroundImage: destination.theme === 'belle-epoque' 
                  ...
                  backgroundSize: destination.theme === 'belle-epoque' ? '30px 30px' : '40px 40px',
                }} />
                ...
                <div className="relative h-full p-8 flex flex-col">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <span className="px-3 py-1 text-xs font-mono tracking-wider rounded-full"
                      style={{ 
                    ...
                    <div className="text-muted-foreground" style={{ color: destination.accentColor }}>
                      {destination.icon}
                    </div>
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-sm font-sans italic" style={{ color: destination.accentColor }}>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-sans text-foreground">{destination.difficulty}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="px-5 py-2 rounded-full text-sm font-sans transition-all flex items-center gap-2"
                      style={{ 
                        backgroundColor: `color-mix(in oklch, ${destination.accentColor} 20%, transparent)`,
                        color: destination.accentColor,
                        border: `1px solid color-mix(in oklch, ${destination.accentColor} 40%, transparent)`
