            ...
            <div className='max-w-7xl mx-auto px-6 py-4'>
                <div className='flex items-center justify-between'>
                    ...
                    <div className='flex items-center gap-3'>
                        <img src='/logo.jpeg' alt='TimeTravel Agency' className='h-10 w-10 rounded-full object-cover' />
                    </div>
                    ...
                    <div className='hidden md:flex items-center gap-8'>
                        <a
                            href='#destinations'
                            className='text-sm font-sans text-muted-foreground hover:text-cyan-glow transition-colors'
                        >
                            Destinations
                        </a>
                        <a
